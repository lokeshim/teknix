  ...
  >
    ...
    <div className="carousel-inner">
      <div className="carousel-item active">
        <Image src="/img/escalators.png" className="d-block w-100" alt="Slide 1" />
        <div className="carousel-caption d-none d-md-block">
          <p className="slider-txt">TESC 20</p>
        </div>
      </div>
      <div className="carousel-item">
        <Image src="/img/escalators.png" className="d-block w-100" alt="Slide 2" />
        <div className="carousel-caption d-none d-md-block">
          <p className="slider-txt">TESC 20</p>
        </div>
      </div>
      <div className="carousel-item">
        <Image src="/img/escalators.png" className="d-block w-100" alt="Slide 3" />
        <div className="carousel-caption d-none d-md-block">
          <p className="slider-txt">TESC 20</p>
        </div>
      </div>
